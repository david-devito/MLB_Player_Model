...
def get_soup(start_season, end_season, league, qual, ind, adjhandVar):
    colList = [5,6,11,12,13,21,34,35,40,41,42,43,44,45,46,47,50,54,65,73]
...
def get_table(soup, ind):
    ...
    percentages = ['BB%','K%','LD%','GB%','FB%','IFFB%','HR/FB','Hard%']
...
def batting_stats(start_season, end_season=None, league='all', qual=1, ind=1, handVar='B'):
    ...
    soup = get_soup(start_season=start_season, end_season=end_season, league=league, qual=qual, ind=ind, adjhandVar=adjhandVar)
