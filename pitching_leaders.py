...
def get_soup(start_season, end_season, league, qual, ind, adjhandVar):
    ...
    colList = [4,37,43,44,45,47,49,58]
    ...
    url =  'http://www.fangraphs.com/leaders.aspx?pos=all&stats=pit&lg={}&qual={}&type=' + colList + '&season={}&month={}&season1={}&ind={}&team=&rost=&age=&filter=&players=&page=1_10000'
...
def pitching_stats(start_season, end_season=None, league='all', qual=1, ind=1, handVar='B'):
    """
